...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::statement("ALTER TABLE inmuebles ADD CONSTRAINT inmuebles_estado_check CHECK (estado::text = ANY (ARRAY['borrador'::text, 'publicado'::text, 'disponible'::text, 'ocupada'::text, 'ocupado'::text, 'reservado'::text, 'inactivo'::text, 'oculto_por_admin'::text]));");
    }
